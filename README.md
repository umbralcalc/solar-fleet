...
a **capacity-siting decision layer** (`python -m solarfleet.decide`) that minimises
aggregate output variability using the calibrated distance-decay covariance, and a
**learned ONNX residual** (`solarfleet/residual.py`) that trains in Python and
